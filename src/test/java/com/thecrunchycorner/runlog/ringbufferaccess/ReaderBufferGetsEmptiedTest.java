...
//
//public class ReaderBufferGetsEmptiedTest {
//
...
//        }
//
//        //All this -1 business is for the test only, we don't need to do that in the application, there we would just read until we are told not to
//        busProcHead = proc.getPos(ProcessorType.BUSINESS_PROCESSOR);
//        for (int i = 0; i < busProcHead; i++) {
//            reader.read();
//        }
//
//        assertThat(reader.read(), is(busProcHead - 1));
//    }
//
//}